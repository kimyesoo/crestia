    ...
    return (
        <div className="min-h-screen bg-background pt-28 pb-8 px-4">
            <div className="max-w-5xl mx-auto">
                {/* Back Button */}
                <Link href="/guide" className="inline-flex items-center gap-2 text-zinc-400 hover:text-white transition mb-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-white mb-2">
                            <span className="text-[#D4AF37]">커뮤니티</span> 가이드
                        </h1>
                        <p className="text-zinc-500">브리더들이 공유하는 사육 노하우</p>
                    </div>
                    {user && (
